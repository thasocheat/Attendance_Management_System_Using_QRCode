    ...
    <form class="space-y-5 dark:text-white" method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <div class="relative text-white-dark">
                <input id="Email" type="email" name="email" required autofocus autocomplete="username" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark">
        ...
        <div>
            ...
            <div class="relative text-white-dark">
                <input id="Password" type="password" name="password" required autocomplete="current-password" placeholder="Enter Password" class="form-input ps-10 placeholder:text-white-dark">
