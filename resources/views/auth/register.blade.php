    ...
    <form class="space-y-5 dark:text-white" method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <div class="relative text-white-dark">
                <input id="Name" type="text" name="name" required autofocus autocomplete="name" placeholder="Enter Name" class="form-input ps-10 placeholder:text-white-dark">
        ...
        <!-- Role -->
        <div>
            <selecte-label for="role" :value="__('Role')" />
        ...
        <div>
            ...
            <div class="relative text-white-dark">
                <input id="Email" type="email" name="email" required autocomplete="username" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark">
        ...
        <div>
            ...
            <div class="relative text-white-dark">
                <input id="Password" type="password" name="password" required autocomplete="new-password" placeholder="Enter Password" class="form-input ps-10 placeholder:text-white-dark">
        ...
        <div>
            ...
            <div class="relative text-white-dark">
                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Enter Confirm Password" class="form-input ps-10 placeholder:text-white-dark">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">
                {{ __('Register') }}
            </x-primary-button>
        </div>
