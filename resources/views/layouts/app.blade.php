...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="{{asset('assets')}}/assets/css/perfect-scrollbar.min.css">
        <link rel="stylesheet" type="text/css" media="screen" href="{{asset('assets')}}/assets/css/style.css">
        <link defer="" rel="stylesheet" type="text/css" media="screen" href="{{asset('assets')}}/assets/css/animate.css">
        <script src="{{asset('assets')}}/assets/js/perfect-scrollbar.min.js"></script>
        <script defer="" src="{{asset('assets')}}/assets/js/popper.min.js"></script>
        <script defer="" src="{{asset('assets')}}/assets/js/tippy-bundle.umd.min.js"></script>
        <script defer="" src="{{asset('assets')}}/assets/js/sweetalert.min.js"></script>
        <link rel="stylesheet" type="text/css" href="{{asset('assets')}}/assets/css/nice-select2.css">
    ...
    <body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
        ...
        <script defer="" src="{{asset('assets')}}/assets/js/apexcharts.js"></script>

        <!-- start hightlight js -->
        <link rel="stylesheet" href="{{asset('assets')}}/assets/css/highlight.min.css">
        <script src="{{asset('assets')}}/assets/js/highlight.min.js"></script>
        <!-- end hightlight js -->
        <script src="{{asset('assets')}}/assets/js/nice-select2.js"></script>
